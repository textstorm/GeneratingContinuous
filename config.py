...
def get_args():
  ...
  parser.add_argument('--hidden_size', type=int, default=256, help='dims of rnn hidden layer')
  ...
  parser.add_argument('--embed_size', type=int, default=256, help='dimension of embed')
  ...
  parser.add_argument('--print_step', type=int, default=10, help='print information step')
